...
<section class="content">
    ...
    <div class="card-body">
        <form action="<?= base_url('guru/latihan/update/'.$soalLatihan['id_soal_latihan']) ?>" method="post"
            ...
            <div class="accordion" id="accordionExample">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="nama_latihan" class="form-control" placeholder="Nama Latihan"
                                    value="<?= $soalLatihan['nama_latihan'] ?>" required>
                            </div>
                            <div class="form-group">
                                ...
                                <select class="form-control" name="id_materi">
                                    ...
                                    <option value="<?= $item['id_materi'] ?>"
                                        <?php if($item['id_materi'] == $soalLatihan['id_materi']) echo 'selected' ?>>
                                        <?= $item['nama_materi'] ?>
                                    </option>
                                    <?php endforeach; ?>
                                </select>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    ...
                                    <textarea rows="1" class="form-control" name="soal_<?= $index + 1 ?>"
                                        placeholder="Isi Soal Disini" required><?= $item['soal'] ?></textarea>
                                </div>
                                <div class="form-group col-md-12">
                ...
                <a href="<?= base_url('guru/latihan') ?>" type="button" class="btn btn-warning">Kembali</a>
            </div>
        </form>
    </div>
</section>
