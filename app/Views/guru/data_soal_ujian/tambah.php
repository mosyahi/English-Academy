...
<section class="content">
    ...
    <div class="card-body">
        <form action="<?= base_url('guru/ujian/add') ?>" method="post" enctype="multipart/form-data">
        ...
        var formSoal = `
            <div class="form-row">
                <div class="form-group col-md-12">
                    <label for="inputCity">Soal Ujian ${i}</label>
                    <textarea rows="1" class="form-control" name="soal_ujian${i}" placeholder="Isi Soal Disini" required></textarea>
                </div>
                <div class="form-group col-md-12">
