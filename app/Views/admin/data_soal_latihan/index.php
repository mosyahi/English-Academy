                        ...
                        <table id="example1" class="table table-bordered table-hover text-center">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= base_url('admin/latihan/lihat/' . $sLatihan['id_soal_latihan']) ?>"
                                            class="btn btn-primary btn-sm btn-circle"> <i
                                                class="nav-icon fas fa-eye"></i>
                                        </a>
                                        <a href="<?= base_url('admin/latihan/edit/' . $sLatihan['id_soal_latihan']) ?>"
                                            class="btn btn-warning btn-sm btn-circle"> <i
                                                class="nav-icon fas fa-edit"></i></a>
                                        <a href="<?= base_url('admin/latihan/delete/' . $sLatihan['id_soal_latihan']) ?>"
                                            class="btn btn-danger btn-sm btn-circle"
                                            onclick="return confirm('Apakah Anda yakin ingin menghapus soal latihan ini?')">
