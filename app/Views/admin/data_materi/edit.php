        ...
        <div class="row">
            <div class="col-md-9 mx-auto">
                <div class="card card-primary">
                    ...
                    <form action="<?= base_url('admin/materi/update/' . $materi['id_materi']) ?>" method="post" enctype="multipart/form-data">
                        <div class="card-body">
                            ...
                            <a href="<?= base_url('admin/materi') ?>" type="button" class="btn btn-warning">Kembali</a>
                        </div>
                    </form>
                </div>
            </div>
