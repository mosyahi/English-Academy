...
<head>
    ...
    <script nonce="ea78fdad-a0a6-4184-bb9a-fd4e86b09002">
        (function(w, d) {
            ! function(f, g, h, i) {
                f[h] = f[h] || {};
                f[h].executed = [];
...
<body class="hold-transition login-page" style="background-image: url('<?= base_url('dist/img/angDImas.jpg') ?>');">
    <div class="login-box">
        <div class="card card-outline card-primary">
            <div class="card-header text-center">
                <img src="<?= base_url() ?>dist/img/logo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8; width: 80px; height: 80px;"><br><br>
                <a href="#" class="h3"><b>English Academy</b><br>
                    SDN 2 Pejambon Cirebon</a>
            </div>
            <div class="card-body">
                <p class="login-box-msg">Silakan Login Untuk Akses Aplikasi</p>
                <?php if (isset($error)) : ?>
