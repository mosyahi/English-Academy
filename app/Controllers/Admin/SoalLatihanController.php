...
class SoalLatihanController extends BaseController
{
    ...
    public function index()
    {
        ...
        $data = [
            'title'         => 'Soal Latihan',
            'activePage'    => 'soal_latihan',
            'soalLatihan'   => $soalLatihanModel
        ];
        return view('admin/data_soal_latihan/index', $data);
    }
    ...
    public function new()
    {
        ...
        $data = [
            ...
            'activePage'    => 'tambah_soal_latihan',
            'materi'        => $dataMateri
        ];
        return view('admin/data_soal_latihan/tambah', $data);
    }
    ...
    // Ambil data soal dalam bentuk array dari form
        ...
        // Menambahkan nomor soal otomatis
            $dataSoal[] = [
            'nomor_soal' => $i, // Nomor soal otomatis
            'soal' => $soal,
            'jawaban_a' => $jawabanA,
            'jawaban_b' => $jawabanB,
            'jawaban_c' => $jawabanC,
    ...
    return redirect()->to('admin/latihan')->with('success', 'Data soal latihan berhasil disimpan.');
}
...
public function lihat($id)
{
    ...
    if ($latihan) {
        ...
        $data = [
            ...
            'activePage' => 'detail_latihan',
            'latihan' => $latihan,
            'materi' => $materiNama
        ];

        return view('admin/data_soal_latihan/detail', $data);
    }
}
...
public function edit($id)
{
    ...
    $data = [
        'title'         => 'Edit Soal',
        'activePage'    => 'edit_soal_latihan',
        'materi'        => $dataMateri,
        'soalLatihan'   => $soalLatihan,
        'soal'          => $soal
    ];

    return view('admin/data_soal_latihan/edit', $data);
}
...
return redirect()->to('admin/latihan')->with('success', 'Data soal latihan berhasil diperbarui.');
}
...
public function delete($id)
{
    ...
    if ($dataLatihan) {
        ...
        session()->setFlashdata('success', 'Data Soal Latihan berhasil dihapus.');
    }
