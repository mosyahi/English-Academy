...
class SoalUjianController extends BaseController
{
    ...
    public function index()
    {
        ...
        $data = [
            'title'         => 'Soal Ujian',
            'activePage'    => 'soal_ujian',
            'soalUjian'   => $soalUjianModel
        ];
        return view('admin/data_soal_ujian/index', $data);
    }
    ...
    public function new()
    {
        ...
        $data = [
            ...
            'activePage'    => 'tambah_soal_ujian',
            'materi'        => $dataMateri
        ];
        return view('admin/data_soal_ujian/tambah', $data);
    }
    ...
    public function add()
    {
        ...
        return redirect()->to('admin/ujian')->with('success', 'Data soal ujian berhasil disimpan.');
    }
    ...
    public function lihat($id)
    {
        ...
        if ($ujian) {
            ...
            $data = [
                'title' => 'Detail Ujian',
                'activePage' => 'detail_ujian',
                'ujian' => $ujian,
                'materi' => $materiNama
            ];

            return view('admin/data_soal_ujian/detail', $data);
        }
    }
    ...
    public function edit($id)
    {
        ...
        $data = [
            'title'         => 'Edit Soal',
            'activePage'    => 'edit_soal_ujian',
            'materi'        => $dataMateri,
            'soalUjian'   => $soalUjian,
            'soal'          => $soal
        ];

        return view('admin/data_soal_ujian/edit', $data);
    }
    ...
    return redirect()->to('admin/ujian')->with('success', 'Data soal ujian berhasil diperbarui.');
}
}